...
contract ElonMiniDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3A0a454DF18822637331E1906bA5d4C72D8347A5); 
    ...
    string private _name = "ElonMiniDoge Token";
    string private _symbol = "ElonMiniDoge";
